...
<div className=" bg-neutral py-6 sm:py-8 lg:py-12">
  <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
    <h2 className="mb-4 text-center text-2xl font-bold text-white font-gil md:mb-8 lg:text-3xl">Trusted by the best</h2>
    ...
    <div className="grid grid-cols-2 gap-6 rounded-lg bg-indigo-100 p-6 sm:h-40 sm:content-evenly md:grid-cols-4">
      <div className="flex justify-center items-center text-indigo-500">
        ...
        <SiMongoosedotws className="h-6 w-auto sm:h-8 lg:h-10" /> <h1 className='font-gil mx-2 md:text-2xl'>Meta</h1>
      </div>

      <div className="flex justify-center items-center text-indigo-500">
     <FaEthereum className="h-6 w-auto sm:h-8 lg:h-10" /> <h1 className='font-gil mx- md:text-2xl'>Ethereum</h1>
      </div>

      <div className="flex justify-center items-center text-indigo-500">
        <GiCrystalBall className="h-6 w-auto sm:h-8 lg:h-10" /> <h1 className='font-gil mx-2 md:text-2xl'>Glob</h1>
      </div>

      <div className="flex justify-center items-center text-indigo-500">
        <GiNinjaHead className="h-6 w-auto sm:h-8 lg:h-10" /> <h1 className='font-gil mx-2 md:text-2xl'>Ninja</h1>
      </div>
    </div>
  </div>
</div>
