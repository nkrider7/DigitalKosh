...
export const Login = () => {
  const { Ragister, Login, googleLogin } = CryptoState();
  ...
  function SignUp() {
    ...
    try {
      ...
      console.log("Plese Check Ragister Detail ", error);
    }
    console.log("Successfull Ragistered");
  }
  function LogIn() {
    try {
      ...
      console.log("Plese Check Login Detail ", error);
    }
  }
            ...
            <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
              <div className="mx-auto max-w-lg rounded-lg ">
                  ...
                  <div role="tablist" className="tabs tabs-boxed">
                    ...
                    role="tab" className={`tab ${login ? 'tab-active' : ' '} transition `}>
                      Login
                    </button>
                    <button 
                ...
                <div className="flex flex-col gap-2 p-4 md:p-4">
                 ...
                 { login? <button
                    onClick={LogIn}
                    className="block rounded-lg bg-neutral px-8 font-gil py-3 text-center text-sm font-semibold border text-white outline-none ring-gray-300 transition duration-100 hover:bg-gray-700 focus-visible:ring active:bg-gray-600 md:text-base"
                  >
                    Log In
                  </button>:
                  <button
